 ...
 */
package org.cytoscape.cytokegg.icons;
...
public class IconLoader {
	...
	public ImageIcon getBackIcon(){
		if(BACK_IMG == null)
			BACK_IMG = new ImageIcon(getClass().getResource("arrow_left.png"));
		return BACK_IMG;
	}
	
	public ImageIcon getForwardIcon(){
		if(FORWARD_IMG == null)
			FORWARD_IMG = new ImageIcon(getClass().getResource("arrow_right.png"));
		return FORWARD_IMG;
	}
	
	public ImageIcon getFolderIcon(){
		if(FOLDER_ADD_IMG == null)
			FOLDER_ADD_IMG = new ImageIcon(getClass().getResource("folder_add.png"));
		return FOLDER_ADD_IMG;
	}
	
	public ImageIcon getDatabaseAddIcon(){
		if(DATABASE_ADD_IMG == null)
			DATABASE_ADD_IMG = new ImageIcon(getClass().getResource("database_add.png"));
		return DATABASE_ADD_IMG;
	}
	
	public ImageIcon getDatabaseDeleteIcon(){
		if(DATABASE_DELETE_IMG == null)
			DATABASE_DELETE_IMG = new ImageIcon(getClass().getResource("database_delete.png"));
		return DATABASE_DELETE_IMG;
	}
	
	public ImageIcon getDatabaseRefreshIcon(){
		if(DATABASE_REFRESH_IMG == null)
			DATABASE_REFRESH_IMG = new ImageIcon(getClass().getResource("database_refresh.png"));
		return DATABASE_REFRESH_IMG;
	}
	
	public ImageIcon getMagnifierIcon(){
		if(MAGNIFIER_IMG == null)
			MAGNIFIER_IMG = new ImageIcon(getClass().getResource("magnifier.png"));
		return MAGNIFIER_IMG;
	}
	
	public ImageIcon getPlayIcon(){
		if(PLAY_IMG == null)
			PLAY_IMG = new ImageIcon(getClass().getResource("control_play.png"));
		return PLAY_IMG;
	}
	
	public ImageIcon getStopIcon(){
		if(STOP_IMG == null)
			STOP_IMG = new ImageIcon(getClass().getResource("control_stop.png"));
		return STOP_IMG;
	}
